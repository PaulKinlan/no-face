...
*/
  ...
  B('Promise', function (a) {
    ...
    b.prototype.u = function (f, h) {
      if (0 != this.h)
        throw Error(
          'Cannot settle(' + f + ', ' + h + '): Promise already settled in state' + this.h
        );
      this.h = f;
      this.i = h;
      2 === this.h && this.G();
      ...
      case 'object':
        if (a && !Array.isArray(a)) {
          ...
          if (a instanceof Ja) {
            var b = a.L;
            b =
              null == b || 'string' === typeof b ? b : Ga && b instanceof Uint8Array ? Ca(b) : null;
            return (a.L = b) || '';
          }
        }
    }
      ...
      function (a, b, c) {
        ...
        if (null != b) {
          ...
          0 === d
            ...
            ? ((d = Math.round(d / Math.pow(2, -149))), (O = 0), (N = ((c << 31) | d) >>> 0))
            ...
            (k = a[e++]),
              128 > k
                ...
                ? e >= d
                  ? L()
                  : ((l = a[e++]),
                    194 > k || 128 !== (l & 192) ? (e--, L()) : f.push(((k & 31) << 6) | (l & 63)))
                : 240 > k
                ? e >= d - 1
                  ? L()
                  : ((l = a[e++]),
        ...
        case 2:
          ...
          if ('object' === typeof window)
            return (
              ...
              Dc('createMediapipeSolutionsPackedAssets', { locateFile: a.locateFile }),
  ...
  function Jc(a) {
    ...
    return J(function (l) {
      ...
      a.C = {};
      if (a.g.listeners)
        for (g = C(a.g.listeners), f = g.next(); !f.done; f = g.next()) (h = f.value), Kc(a, h);
      k = a.j;
      a.j = {};
      a.setOptions(k);
      l.g = 0;
        ...
        case 2:
          ...
          if ('detection_list' === q.type) {
            if (p) {
              var A = p.getRectList();
              for (
                var I = p.getLandmarksList(), F = p.getClassificationsList(), u = [], z = 0;
                z < A.size();
                ++z
              ) {
  ...
  function Nc(a, b, c) {
    var d;
    return J(function (e) {
      return 'number' === typeof c || c instanceof Uint8Array || c instanceof a.h.Uint8BlobList
        ? e.return(c)
        : c instanceof a.h.Texture2dDataOut
        ? ((d = a.u[b]), d || ((d = new xc(a.h, a.G)), (a.u[b] = d)), e.return(yc(d, c, a.I)))
        : e.return(void 0);
    });
  }
  function Kc(a, b) {
